export const LOBBY_CLIENT_EVENTS = Object.freeze({
    ...
    // R20 — room Owner commits the authoritative room network (one-time,
...
export const LOBBY_SERVER_EVENTS = Object.freeze({
    ...
    // R7.7A — authoritative per-player Matrix submission lifecycle.
    SECRET_MATRIX_STATUS: "SECRET_MATRIX_STATUS",
...
export const LOBBY_ERROR_CODES = Object.freeze({
    ...
    // R20 — Owner-only one-time room network selection (testnet | mainnet).
